...
async function x(){
  ...
  // PER-MESSAGE SOURCES (NEW IN v18.1)
  try{
  ...
  // SIDEBAR SOURCES (legacy - kept for compatibility)
  try{
  ...
  el.download="perplexity_v18.1_"+new Date().toISOString().slice(0,10)+".md";
